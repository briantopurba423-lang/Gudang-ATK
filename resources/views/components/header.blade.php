<nav style="background:#34495e; padding:14px 30px; display:flex; justify-content:space-between; align-items:center;">
    ...
    <div style="display:flex; gap:20px;">
        ...
        <a href="{{ route('pages.product') }}" style="color:white; text-decoration:none; font-size:14px;">Produk</a>
        <a href="{{ route('login.form') }}" style="color:white; text-decoration:none; font-size:14px;">Login</a>
    </div>
</nav>
