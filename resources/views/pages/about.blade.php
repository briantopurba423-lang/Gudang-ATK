        ...
        ">
            ...
            ">
                <div style="text-align:center;">
                    <img src="{{ asset('foto1.jpg') }}" style="width:50%; border-radius:12px; object-fit:cover;">
                    <p style="margin-top:8px; font-size:14px; color:#475569;">HVS</p>
                </div>

                <div style="text-align:center;">
                    <img src="{{ asset('foto2.jpg') }}" style="width:50%; border-radius:12px; object-fit:cover;">
                    <p style="margin-top:8px; font-size:14px; color:#475569;">PENA</p>
                </div>

                <div style="text-align:center;">
                    <img src="{{ asset('foto3.jpg') }}" style="width:50%; border-radius:12px; object-fit:cover;">
