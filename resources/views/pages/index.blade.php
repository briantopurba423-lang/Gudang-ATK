...
@section('title', 'ATK System - Dashboard Admin')
...
<style>
    ...
    /* SIDEBAR */
    .sidebar { width:220px; background:#34495e; color:white; padding:20px 0; display:flex; flex-direction:column; min-height:100vh; position:fixed; z-index:200; }
    .sidebar h2 { text-align:center; margin-bottom:20px; font-size:18px; padding:0 10px; }
    .sidebar a { display:block; color:white; padding:14px 20px; text-decoration:none; cursor:pointer; font-size:14px; border-left:4px solid transparent; }
    .sidebar a:hover, .sidebar a.active { background:#2c3e50; border-left-color:#3498db; }
    ...
    /* MAIN */
    .main { margin-left:220px; flex:1; padding:80px 24px 24px; overflow-y:auto; width:100%; }
...
<div class="admin-wrapper">
    ...
    <div class="main">
        ...
        {{-- ===== DASHBOARD ===== --}}
        <div id="dashboard">
            <h1 style="margin-top:0;color:#2c3e50;margin-bottom:20px;">Dashboard ATK</h1>
            <div class="cards">
                <div class="card blue">
            ...
            <div class="section-box">
                ...
                <table>
                    <tr><th>No</th><th>Kode</th><th>Nama Barang</th><th>Kategori</th><th>Stok</th><th>Status</th></tr>
                    @forelse($barang as $b)
                    <tr>
        ...
        <div id="kategori" class="hidden">
            <div class="section-box">
                ...
                <table>
                    <tr><th>No</th><th>Nama Kategori</th><th>Deskripsi</th><th>Jumlah Barang</th><th>Aksi</th></tr>
        ...
        <div id="barang" class="hidden">
            <div class="section-box">
                ...
                <table>
                    <tr><th>No</th><th>Kode Barang</th><th>Nama Barang</th><th>Kategori</th><th>Stok</th><th>Aksi</th></tr>
                    @forelse($barang as $b)
                    <tr>
                        <td>{{ $loop->iteration }}</td>
                        <td><span class="badge badge-kode">{{ $b->kode_barang }}</span></td>
        ...
        <div id="supplier" class="hidden">
            <div class="section-box">
                ...
                <table>
                    <tr><th>No</th><th>Nama Supplier</th><th>Kontak</th><th>Alamat</th><th>Aksi</th></tr>
        ...
        <div id="masuk" class="hidden">
            ...
            <div class="section-box">
                ...
                <table>
                    <tr><th>No</th><th>Nama Barang</th><th>Supplier</th><th>Jumlah</th><th>Tanggal</th></tr>
        ...
        <div id="keluar" class="hidden">
            ...
            <div class="section-box">
                ...
                <table>
                    <tr><th>No</th><th>Nama Barang</th><th>Jumlah</th><th>Tanggal</th></tr>
